...
cs             0x8  
```  
notice _0x8_ is the value ljmpl specified. But I'm not sure why it's 0x08 (number 1 descriptor). Needs to look back later.    
...
0xfd273:   mov    %eax,%gs  
```  
not sure why these selectors are set to 0x10(number 2 descriptor). May need to look later.  
